                ...
                <ContentTemplate>
                    <div class="mb-3 d-flex align-items-center">
                        ...
                        <asp:RegularExpressionValidator ID="revURLIMAGEN" runat="server" ControlToValidate="txtURLIMAGEN"
                            ValidationExpression="^(http|https):\/\/[\w\-]+(\.[\w\-]+)+([\w\-\.,@?^=%&amp;:/~\+#]*[\w\-\@?^=%&amp;/~\+#])?$" ErrorMessage="*El campo URLIMAGEN no puede contener espacios en blanco" CssClass="text-danger" ValidationGroup="validacionGrupo"></asp:RegularExpressionValidator>
